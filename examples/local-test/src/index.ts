...
//     const contract = await pixchain.contracts.getContractAt<ERC721Sample>(deploy.contractDeploymentId);
//     console.log(deploy);
...
//       const mintTransaction = await pixchain.transactions.getTransactionAt(mint.transactionId);
//       console.log('transaction', mintTransaction);
//     }
//   }

//   const myDeployment = await pixchain.contracts.getDeploymentByOwner({
//     address,
//     chainId: 4,
//   });
